package com.fastest.services.test.controllers;
...
import com.fastest.data.test.models.PingRequest;
import com.fastest.data.test.models.PingResponse;
...
public class TestController {
    ...
    public PingResponse ping(
        ...
        return new PingResponse("Hello from Test - " + request.getId() + " - " + request.getMessage());
    }
